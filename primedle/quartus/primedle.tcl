...
# File: primedle.tcl
# Generated on: Thu Mar 24 17:36:38 2022
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "primedle"]} {
		puts "Project primedle is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists primedle]} {
		project_open -revision primedle primedle
	} else {
		project_new -revision primedle primedle
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "16:32:31  MARCH 21, 2022"
	...
	set_global_assignment -name VHDL_FILE "../entities/timer-entity.vhd"
	set_global_assignment -name VHDL_FILE "../entities/timed_button-entity.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/timer-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/timed_button-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../entities/rand_gen-entity.vhd"
	set_global_assignment -name VHDL_FILE "../entities/prime_checker-entity.vhd"
	set_global_assignment -name VHDL_FILE "../entities/game_ctrl-entity.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/rand_gen-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/prime_checker-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/game_ctrl-rtl.vhd"
	set_global_assignment -name VHDL_FILE ../packages/primes_pkg.vhd
	set_global_assignment -name VHDL_FILE ../packages/game_types_pkg.vhd
	set_global_assignment -name VHDL_FILE "../architectures/seg_decoder-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/primedle-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/led_driver-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../architectures/debouncer-rtl.vhd"
	set_global_assignment -name VHDL_FILE "../entities/seg_decoder-entity.vhd"
	set_global_assignment -name VHDL_FILE "../entities/primedle-entity.vhd"
	set_global_assignment -name VHDL_FILE "../entities/led_driver-entity.vhd"
	set_global_assignment -name VHDL_FILE "../entities/debouncer-entity.vhd"
	set_global_assignment -name TCL_SCRIPT_FILE ../scripts/clocks.tcl
	set_global_assignment -name TCL_SCRIPT_FILE ../scripts/dip_switches.tcl
	...
	set_global_assignment -name TCL_SCRIPT_FILE ../scripts/switches.tcl
	set_global_assignment -name SDC_FILE clocks_sdc.tcl
	set_location_assignment PIN_T22 -to clk
	set_location_assignment PIN_V11 -to golden_in[7]
	set_location_assignment PIN_V10 -to golden_in[6]
	set_location_assignment PIN_AB10 -to golden_in[5]
	set_location_assignment PIN_AA10 -to golden_in[4]
	set_location_assignment PIN_AB9 -to golden_in[3]
	set_location_assignment PIN_AA9 -to golden_in[2]
	set_location_assignment PIN_AB8 -to golden_in[1]
	set_location_assignment PIN_AA8 -to golden_in[0]
	set_location_assignment PIN_Y8 -to guess_in[7]
	set_location_assignment PIN_AB7 -to guess_in[6]
	set_location_assignment PIN_AA7 -to guess_in[5]
	set_location_assignment PIN_Y7 -to guess_in[4]
	set_location_assignment PIN_Y6 -to guess_in[3]
	set_location_assignment PIN_AB5 -to guess_in[2]
	set_location_assignment PIN_AA5 -to guess_in[1]
	set_location_assignment PIN_AB4 -to guess_in[0]
	...
	set_location_assignment PIN_T3 -to seg3[0]
	set_location_assignment PIN_R6 -to seg3[1]
	set_location_assignment PIN_R5 -to seg3[2]
	set_location_assignment PIN_P7 -to seg3[3]
	set_location_assignment PIN_N8 -to seg3[4]
	set_location_assignment PIN_N7 -to seg3[5]
	set_location_assignment PIN_F13 -to seg3[6]
	set_location_assignment PIN_P6 -to seg3[7]
	...
	set_location_assignment PIN_U9 -to seg1[0]
	set_location_assignment PIN_W8 -to seg1[1]
	set_location_assignment PIN_V8 -to seg1[2]
	set_location_assignment PIN_Y4 -to seg1[3]
	set_location_assignment PIN_T11 -to seg1[4]
	set_location_assignment PIN_Y10 -to seg1[5]
	set_location_assignment PIN_T10 -to seg1[6]
	set_location_assignment PIN_W7 -to seg1[7]
	set_location_assignment PIN_U11 -to seg0[0]
	set_location_assignment PIN_G18 -to seg0[1]
	set_location_assignment PIN_M8 -to seg0[2]
	set_location_assignment PIN_L6 -to seg0[3]
	set_location_assignment PIN_W10 -to seg0[4]
	set_location_assignment PIN_U10 -to seg0[5]
	set_location_assignment PIN_V9 -to seg0[6]
	set_location_assignment PIN_L7 -to seg0[7]
	set_location_assignment PIN_AA11 -to n_check_btn
	set_location_assignment PIN_AB11 -to n_reset
